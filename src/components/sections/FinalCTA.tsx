  ...
  return (
    <section className="py-24 px-6 md:px-12" id="cta">
      <div className="max-w-7xl mx-auto relative group">
        ...
        <div className="bg-[#041d14] rounded-[2rem] md:rounded-[4rem] overflow-hidden relative border border-white/5 min-h-[400px] md:min-h-[500px] flex items-center shadow-2xl">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 w-full px-6 md:px-24 py-16 md:py-20 lg:py-0 relative z-10">
            ...
            <div className="lg:col-span-7 flex flex-col justify-center text-center lg:text-left">
              ...
              <motion.div
                ...
                viewport={{ once: true }}
              >
                <p className="text-base md:text-xl text-white/50 font-medium mb-10 md:mb-12 max-w-xl leading-relaxed">
                  Join thousands of professionals already using JobVanta to transform their career path with AI precision.
                </p>

                {/* High-Impact CTA Button */}
                <div className="flex justify-center lg:justify-start">
                  <button className="group relative flex items-center gap-4 md:gap-6 px-8 md:px-10 py-4 md:py-5 bg-emerald-500 rounded-full text-white font-black text-lg md:text-xl hover:bg-emerald-400 transition-all duration-300 shadow-xl shadow-emerald-500/20 active:scale-95">
                    Get It Now
                    <div className="w-10 h-10 md:w-12 md:h-12 bg-slate-900 rounded-full flex items-center justify-center group-hover:bg-black transition-colors">
        ...
        <motion.div
          ...
          className="absolute -left-12 -bottom-1 lg:-left-20 lg:-bottom-1 w-[280px] md:w-[400px] lg:w-[600px] pointer-events-none z-20 hidden md:block"
        >
